...
// RUN: %klee -libc=uclibc -posix-runtime -output-dir=%t-O0.klee-out -detect-infinite-loops -emit-all-errors -stop-after-n-instructions=100000 -allocate-determ %t-O0.bc 2>&1 | FileCheck %s
